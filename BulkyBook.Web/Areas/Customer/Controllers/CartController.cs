...
using BulkyBook.Entities.ViewModels;
...
namespace BulkyBook.Web.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                CartsList = _unitOfWork.ShoppingCart.GetAll(u=>u.ApplicationUserId == claim , Includeword:"Product"),                
            };
   ...
   //     }
        ...
        {
            ShoppingCart orderHeader = _unitOfWork.ShoppingCart.GetFirstorDefault(u=>u.Id == id);
			//var service = new SessionService();
